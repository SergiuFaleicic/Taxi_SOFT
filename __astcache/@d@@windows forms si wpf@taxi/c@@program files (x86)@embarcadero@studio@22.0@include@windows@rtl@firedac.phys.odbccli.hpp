...
// (DO NOT EDIT: machine generated header) 'FireDAC.Phys.ODBCCli.pas' rev: 35.00 (Windows)
...
#ifndef _WIN64
typedef short __stdcall (*TSQLBindCol)(void * StatementHandle, System::Word ColumnNumber, short TargetType, void * TargetValue, int BufferLength, PSQLLen StrLen_or_Ind);
#else /* _WIN64 */
typedef short __stdcall (*TSQLBindCol)(void * StatementHandle, System::Word ColumnNumber, short TargetType, void * TargetValue, __int64 BufferLength, PSQLLen StrLen_or_Ind);
#endif /* _WIN64 */
...
#else /* _WIN64 */
typedef short __stdcall (*TSQLBindParam)(void * StatementHandle, System::Word ParameterNumber, short ValueType, short ParameterType, unsigned __int64 LengthPrecision, short ParameterScale, void * ParameterValue, __int64 &StrLen_or_Ind);
#endif /* _WIN64 */

typedef short __stdcall (*TSQLCancel)(void * StatementHandle);

typedef short __stdcall (*TSQLCancelHandle)(short HandleType, void * InputHandle);

typedef short __stdcall (*TSQLCloseCursor)(void * StatementHandle);

typedef short __stdcall (*TSQLColAttribute)(void * StatementHandle, System::Word ColumnNumber, System::Word FieldIdentifier, void * CharacterAttribute, short BufferLength, PSQLSmallint StringLength, PSQLLen NumericAttributePtr);

typedef short __stdcall (*TSQLColAttributeString)(void * StatementHandle, System::Word ColumnNumber, System::Word FieldIdentifier, void * CharacterAttribute, short BufferLength, short &StringLength, PSQLLen NumericAttribute);
...
#else /* _WIN64 */
typedef short __stdcall (*TSQLColAttributeInt)(void * StatementHandle, System::Word ColumnNumber, System::Word FieldIdentifier, void * CharacterAttribute, short BufferLength, PSQLSmallint StringLength, __int64 &NumericAttribute);
#endif /* _WIN64 */

typedef short __stdcall (*TSQLColumns)(void * StatementHandle, PSQLChar CatalogName, short NameLength1, PSQLChar SchemaName, short NameLength2, PSQLChar TableName, short NameLength3, PSQLChar ColumnName, short NameLength4);

typedef short __stdcall (*TSQLConnect)(void * ConnectionHandle, PSQLChar ServerName, short NameLength1, PSQLChar UserName, short NameLength2, PSQLChar Authentication, short NameLength3);

typedef short __stdcall (*TSQLCopyDesc)(void * SourceDescHandle, void * TargetDescHandle);

typedef short __stdcall (*TSQLDataSources)(void * EnvironmentHandle, System::Word Direction, PSQLChar ServerName, short BufferLength1, short &NameLength1, PSQLChar Description, short BufferLength2, short &NameLength2);

#ifndef _WIN64
typedef short __stdcall (*TSQLDescribeCol)(void * StatementHandle, System::Word ColumnNumber, PSQLChar ColumnName, short BufferLength, short &NameLength, short &DataType, int &ColumnSize, short &DecimalDigits, short &Nullable);
#else /* _WIN64 */
typedef short __stdcall (*TSQLDescribeCol)(void * StatementHandle, System::Word ColumnNumber, PSQLChar ColumnName, short BufferLength, short &NameLength, short &DataType, unsigned __int64 &ColumnSize, short &DecimalDigits, short &Nullable);
#endif /* _WIN64 */
...
typedef short __stdcall (*TSQLError)(void * EnvironmentHandle, void * ConnectionHandle, void * StatementHandle, System::WideChar &SQLstate, int &NativeError, System::WideChar &MessageText, short BufferLength, short &TextLength);

typedef short __stdcall (*TSQLExecDirect)(void * StatementHandle, PSQLChar StatementText, int TextLength);
...
#else /* _WIN64 */
typedef short __stdcall (*TSQLFetchScroll)(void * StatementHandle, short FetchOrientation, __int64 FetchOffset);
#endif /* _WIN64 */
...
typedef short __stdcall (*TSQLGetConnectAttr)(void * ConnectionHandle, int Attribute, void * ValuePtr, int BufferLength, int &StringLength);

typedef short __stdcall (*TSQLGetConnectOption)(void * ConnectionHandle, System::Word Option, void * Value);

typedef short __stdcall (*TSQLGetCursorName)(void * StatementHandle, PSQLChar CursorName, short BufferLength, short &NameLength);

#ifndef _WIN64
typedef short __stdcall (*TSQLGetData)(void * StatementHandle, System::Word ColumnNumber, short TargetType, void * TargetValue, int BufferLength, PSQLLen StrLen_or_Ind);
#else /* _WIN64 */
typedef short __stdcall (*TSQLGetData)(void * StatementHandle, System::Word ColumnNumber, short TargetType, void * TargetValue, __int64 BufferLength, PSQLLen StrLen_or_Ind);
#endif /* _WIN64 */
...
#ifndef _WIN64
typedef short __stdcall (*TSQLGetDescRec)(void * DescriptorHandle, short RecNumber, System::WideChar &Name, short BufferLength, short &StringLength, short &_Type, short &SubType, int &Length, short &Precision, short &Scale, short &Nullable);
#else /* _WIN64 */
typedef short __stdcall (*TSQLGetDescRec)(void * DescriptorHandle, short RecNumber, System::WideChar &Name, short BufferLength, short &StringLength, short &_Type, short &SubType, __int64 &Length, short &Precision, short &Scale, short &Nullable);
#endif /* _WIN64 */
...
typedef short __stdcall (*TSQLGetDiagRec)(short HandleType, void * Handle, short RecNumber, PSQLChar SQLstate, int &NativeError, PSQLChar MessageText, short BufferLength, short &TextLength);
...
typedef short __stdcall (*TSQLGetInfoString)(void * ConnectionHandle, System::Word InfoType, PSQLChar InfoValueString, short BufferLength, short &StringLength);
...
#ifndef _WIN64
typedef short __stdcall (*TSQLGetInfoSQLLen)(void * ConnectionHandle, System::Word InfoType, int &InfoValue, short Ignored1, void * Ignored2);
#else /* _WIN64 */
typedef short __stdcall (*TSQLGetInfoSQLLen)(void * ConnectionHandle, System::Word InfoType, unsigned __int64 &InfoValue, short Ignored1, void * Ignored2);
#endif /* _WIN64 */

typedef short __stdcall (*TSQLGetStmtAttr)(void * StatementHandle, int Attribute, void * Value, int BufferLength, int &StringLength);
...
typedef short __stdcall (*TSQLPrepare)(void * StatementHandle, PSQLChar StatementText, int TextLength);

#ifndef _WIN64
typedef short __stdcall (*TSQLPutData)(void * StatementHandle, void * Data, int StrLen_or_Ind);
#else /* _WIN64 */
typedef short __stdcall (*TSQLPutData)(void * StatementHandle, void * Data, __int64 StrLen_or_Ind);
#endif /* _WIN64 */

#ifndef _WIN64
typedef short __stdcall (*TSQLRowCount)(void * StatementHandle, int &RowCount);
#else /* _WIN64 */
typedef short __stdcall (*TSQLRowCount)(void * StatementHandle, __int64 &RowCount);
#endif /* _WIN64 */
...
#else /* _WIN64 */
typedef short __stdcall (*TSQLSetConnectOption)(void * ConnectionHandle, System::Word Option, unsigned __int64 Value);
#endif /* _WIN64 */

typedef short __stdcall (*TSQLSetCursorName)(void * StatementHandle, PSQLChar CursorName, short NameLength);
...
#else /* _WIN64 */
typedef short __stdcall (*TSQLSetDescRec)(void * DescriptorHandle, short RecNumber, short _Type, short SubType, __int64 Length, short Precision, short Scale, void * Data, __int64 &StringLength, __int64 &Indicator);
#endif /* _WIN64 */
...
#else /* _WIN64 */
typedef short __stdcall (*TSQLSetParam)(void * StatementHandle, System::Word ParameterNumber, short ValueType, short ParameterType, unsigned __int64 LengthPrecision, short ParameterScale, void * ParameterValue, __int64 &StrLen_or_Ind);
#endif /* _WIN64 */
...
#else /* _WIN64 */
typedef short __stdcall (*TSQLSetStmtOption)(void * StatementHandle, System::Word Option, unsigned __int64 Value);
#endif /* _WIN64 */

typedef short __stdcall (*TSQLSpecialColumns)(void * StatementHandle, System::Word IdentifierType, PSQLChar CatalogName, short NameLength1, PSQLChar SchemaName, short NameLength2, PSQLChar TableName, short NameLength3, System::Word Scope, System::Word Nullable);

typedef short __stdcall (*TSQLStatistics)(void * StatementHandle, PSQLChar CatalogName, short NameLength1, PSQLChar SchemaName, short NameLength2, PSQLChar TableName, short NameLength3, System::Word Unique, System::Word Reserved);

typedef short __stdcall (*TSQLTables)(void * StatementHandle, PSQLChar CatalogName, short NameLength1, PSQLChar SchemaName, short NameLength2, PSQLChar TableName, short NameLength3, PSQLChar TableType, short NameLength4);
...
typedef short __stdcall (*TSQLDriverConnect)(void * HDbc, NativeUInt hwnd, PSQLChar szConnStrIn, short cbConnStrIn, PSQLChar szConnStrOut, short cbConnStrOutMax, short &pcbConnStrOut, System::Word fDriverCompletion);

typedef short __stdcall (*TSQLBrowseConnect)(void * HDbc, PSQLChar szConnStrIn, short cbConnStrIn, PSQLChar szConnStrOut, short cbConnStrOutMax, short &pcbConnStrOut);
...
typedef short __stdcall (*TSQLColumnPrivileges)(void * HStmt, System::WideChar &szCatalogName, short cbCatalogName, System::WideChar &szSchemaName, short cbSchemaName, System::WideChar &szTableName, short cbTableName, System::WideChar &szColumnName, short cbColumnName);
...
#else /* _WIN64 */
typedef short __stdcall (*TSQLDescribeParam)(void * HStmt, System::Word ipar, short &pfSQLType, unsigned __int64 &pcbParamDef, short &pibScale, short &pfNullable);
#endif /* _WIN64 */

#ifndef _WIN64
typedef short __stdcall (*TSQLExtendedFetch)(void * HStmt, System::Word fFetchType, int irow, int &pcrow, System::Word &rgfRowStatus);
#else /* _WIN64 */
typedef short __stdcall (*TSQLExtendedFetch)(void * HStmt, System::Word fFetchType, __int64 irow, unsigned __int64 &pcrow, System::Word &rgfRowStatus);
#endif /* _WIN64 */

typedef short __stdcall (*TSQLForeignKeys)(void * HStmt, PSQLChar szPkCatalogName, short cbPkCatalogName, PSQLChar szPkSchemaName, short cbPkSchemaName, PSQLChar szPkTableName, short cbPkTableName, PSQLChar szFkCatalogName, short cbFkCatalogName, PSQLChar szFkSchemaName, short cbFkSchemaName, PSQLChar szFkTableName, short cbFkTableName);

typedef short __stdcall (*TSQLMoreResults)(void * HStmt);

typedef short __stdcall (*TSQLNativeSQL)(void * HDbc, System::WideChar &szSQLStrIn, int cbSQLStrIn, System::WideChar &szSQLStr, int cbSQLStrMax, int &pcbSQLStr);
...
#else /* _WIN64 */
typedef short __stdcall (*TSQLParamOptions)(void * HStmt, unsigned __int64 crow, unsigned __int64 &pirow);
#endif /* _WIN64 */

typedef short __stdcall (*TSQLPrimaryKeys)(void * HStmt, PSQLChar szCatalogName, short cbCatalogName, PSQLChar szSchemaName, short cbSchemaName, PSQLChar szTableName, short cbTableName);

typedef short __stdcall (*TSQLProcedureColumns)(void * HStmt, PSQLChar szCatalogName, short cbCatalogName, PSQLChar szSchemaName, short cbSchemaName, PSQLChar szProcName, short cbProcName, PSQLChar szColumnName, short cbColumnName);

typedef short __stdcall (*TSQLProcedures)(void * HStmt, PSQLChar szCatalogName, short cbCatalogName, PSQLChar szSchemaName, short cbSchemaName, PSQLChar szProcName, short cbProcName);

#ifndef _WIN64
typedef short __stdcall (*TSQLSetPos)(void * HStmt, System::Word irow, System::Word fOption, System::Word fLock);
#else /* _WIN64 */
typedef short __stdcall (*TSQLSetPos)(void * HStmt, unsigned __int64 irow, System::Word fOption, System::Word fLock);
#endif /* _WIN64 */

typedef short __stdcall (*TSQLTablePrivileges)(void * HStmt, System::WideChar &szCatalogName, short cbCatalogName, System::WideChar &szSchemaName, short cbSchemaName, System::WideChar &szTableName, short cbTableName);

typedef short __stdcall (*TSQLDrivers)(void * HEnv, System::Word fDirection, PSQLChar szDriverDesc, short cbDriverDescMax, short &pcbDriverDesc, PSQLChar szDriverAttributes, short cbDrvrAttrMax, short &pcbDrvrAttr);

#ifndef _WIN64
typedef short __stdcall (*TSQLBindParameter)(void * HStmt, System::Word ipar, short fParamType, short fCType, short fSQLType, int cbColDef, short ibScale, void * rgbValue, int cbValueMax, PSQLLen pcbValue);
#else /* _WIN64 */
typedef short __stdcall (*TSQLBindParameter)(void * HStmt, System::Word ipar, short fParamType, short fCType, short fSQLType, unsigned __int64 cbColDef, short ibScale, void * rgbValue, __int64 cbValueMax, PSQLLen pcbValue);
#endif /* _WIN64 */
...
#else /* _WIN64 */
typedef short __stdcall (*TSQLSetScrollOptions)(void * HStmt, System::Word fConcurrency, __int64 crowKeyset, System::Word crowRowset);
#endif /* _WIN64 */

typedef System::WordBool __stdcall (*TSQLConfigDataSource)(NativeUInt hwndParent, System::Word fRequest, PSQLChar lpszDriver, PSQLChar lpszAttributes);

typedef short __stdcall (*TSQLInstallerError)(System::Word iError, unsigned &pfErrorCode, PSQLChar lpszErrorMsg, System::Word cbErrorMsgMax, System::Word &pcbErrorMsg);
