...
// (DO NOT EDIT: machine generated header) 'FireDAC.Phys.ODBCWrapper.pas' rev: 35.00 (Windows)
...
private:
	...
	System::WideChar FSearchPatternEscape;
	bool FTracing;
...
public:
	...
	__property System::WideChar SEARCH_PATTERN_ESCAPE = {read=FSearchPatternEscape, nodefault};
...
public:
	...
	__property bool MSSQLVariantBinary = {read=FMSSQLVariantBinary, write=FMSSQLVariantBinary, nodefault};
	__property bool LimitedToMaxLen = {read=FLimitedToMaxLen, write=FLimitedToMaxLen, nodefault};
...
private:
	...
	System::UnicodeString __fastcall EscapeSpecChars(const System::UnicodeString AStr);
